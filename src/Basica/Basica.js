...
const calculator = (type, value, state) => {
  switch (type) {
    ...
    case "Bin":
      return {
        currentValue: parseInt(state.currentValue, 10).toString(2),
      };
    case "Oct":
      return {
        currentValue: parseInt(state.currentValue, 10).toString(8),
      };
    case "Hex":
      return {
        currentValue: parseInt(state.currentValue, 10).toString(16),
      };
    case "Sin":
      return {
        currentValue: `${sin(state.currentValue)}`,
      };
    case "Cos":
      return {
        currentValue: `${cos(state.currentValue)}`,
      };
    case "Tan":
      return {
...
//calculadora 2
export const handleButtonPress = (text) => {
  switch (text) {
    case "C":
      setValue("");
      break;
